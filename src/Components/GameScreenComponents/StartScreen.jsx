function startScreen({startWithDog}) {
    return (
        <div className="w-2/4 p-5 mx-5 bg-gradient-to-b from-blue-400 to-blue-600 rounded-2xl flex flex-col items-center text-white">
            ...
            <button onClick={() => startWithDog()} className="text-sm shadow-lg text-white font-semibold bg-blue-900 text-center align-middle p-2 mt-5 rounded-xl hover:scale-110 duration-200">Play the memory game with dogs</button>
        </div>
    )
}
